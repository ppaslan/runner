...
DEFAULT_RUNNER_VERSION=12.6.4 # renovate: datasource=forgejo-releases depName=forgejo/runner
...
YQ_VERSION=v4.52.2 # renovate: datasource=github-releases depName=forgejo-runner-service-yq packageName=mikefarah/yq
SELF=${BASH_SOURCE[0]}
